...
python train_attribute_clf.py celeba ./results/multi_clf --multi=True --even=True --multi_class_idx 20
cd ../CelebA_data_split
python .\gen_celebA_dataset.py --multi=True --split_type test --mode_normal=0 --multi=True  --multi_class_idx 20
cd ../Testing_metrics
...
cd ../CelebA_data_split
python .\gen_celebA_dataset.py --multi=True --split_type test --mode_normal=0 --multi=True  --multi_class_idx 39
cd ../Testing_metrics
for /l %%x in (0, 1, 2) do python sample_test.py --multi=True --multi_class_idx 39 --index=%%x
