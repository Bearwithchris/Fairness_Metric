...
python validate_acc.py celeba ./results/multi_clf_2/model_best.pth.tar --even=1 --multi=1 --multi_class_idx 20
...
python validate_acc.py celeba ./results/multi_clf_4/model_best.pth.tar --even=1 --multi=1 --multi_class_idx 20 8
...
python validate_acc.py celeba ./results/multi_clf_8/model_best.pth.tar --even=1 --multi=1 --multi_class_idx 20 8 31
...
python validate_acc.py celeba ./results/multi_clf_16/model_best.pth.tar --even=1 --multi=1 --multi_class_idx 20 8 31 5
