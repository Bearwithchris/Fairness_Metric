...
python .\gen_celebA_dataset.py --multi=1 --mode_normal=2 --split_type test --multi=1  --multi_class_idx 20
...
for /l %%x in (0, 1, 77) do python sample_test.py --multi=1 --multi_class_idx 20 --index=%%x
