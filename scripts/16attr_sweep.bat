...
python .\gen_celebA_dataset.py --step_mul=2 --multi=1 --split_type test --multi=1 --mode_normal=2  --multi_class_idx 20 8 31 5
cd ../Testing_metrics
for /l %%x in (0, 1, 389) do python sample_test.py --multi_clf_path=multi_clf_16 --multi=1 --multi_class_idx 20 8 31 5 --index=%%x
