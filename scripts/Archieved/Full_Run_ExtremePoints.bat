...
cd ../CelebA_data_split
python .\gen_celebA_dataset.py --multi=1 --mode_normal=0 --split_type test --multi=1  --multi_class_idx 20 8 7
cd ../Testing_metrics
for /l %%x in (0, 1, 8) do python sample_test.py --multi=1 --multi_class_idx 20 8 7 --index=%%x
...
cd ../CelebA_data_split
python .\gen_celebA_dataset.py --multi=1 --mode_normal=0 --split_type test --multi=1  --multi_class_idx 20 8 7 6
cd ../Testing_metrics
for /l %%x in (0, 1, 16) do python sample_test.py --multi=1 --multi_class_idx 20 8 7 6 --index=%%x