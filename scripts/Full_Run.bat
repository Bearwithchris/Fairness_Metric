...
cd ../Testing_metrics
for /l %%x in (1, 1, 24) do python sample_test.py --multi=True --multi_class_idx 20 --index=%%x
...
cd ../Testing_metrics
for /l %%x in (1, 1, 24) do python sample_test.py --multi=True --multi_class_idx 20 8 --index=%%x
...
cd ../Testing_metrics
for /l %%x in (1, 1, 24) do python sample_test.py --multi=True --multi_class_idx 20 8 7 --index=%%x
...
cd ../Testing_metrics
for /l %%x in (1, 1, 24) do python sample_test.py --multi=True --multi_class_idx 20 8 7 6 --index=%%x