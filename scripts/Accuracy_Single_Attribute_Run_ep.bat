...
python .\gen_celebA_dataset.py --multi=1 --split_type test --mode_normal=0 --multi=1  --multi_class_idx 20
cd ../Testing_metrics
for /l %%x in (0, 1, 2) do python sample_test.py --multi=1 --multi_clf_path=multi_clf_4 --multi_class_idx 20 --index=%%x
...
cd ../CelebA_data_split
python .\gen_celebA_dataset.py --multi=1 --split_type test --mode_normal=0 --multi=1  --multi_class_idx 39
cd ../Testing_metrics
for /l %%x in (0, 1, 2) do python sample_test.py --multi=1 --multi_clf_path=multi_clf_4  --multi_class_idx 39 --index=%%x
