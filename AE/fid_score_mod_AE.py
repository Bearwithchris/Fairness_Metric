# -*- coding: utf-8 -*-
"""
Created on Mon Mar  8 14:23:22 2021
...
def calculate_activation_statistics(files, model, batch_size=50,
    ...
    -- sigma : The covariance matrix of the activations of the pool_3 layer of
               the inception model.
    """
    # activation_path=".\\FID_activation"
    # print (activation_path+files.strip(".npz").strip("./samples").strip("//"))
    # time.sleep(1000)
    
    act = get_activations(files, model, batch_size, dims, cuda, verbose)
    
    #Added to study FID activation====================================
    # if (os.path.exists(activation_path)):
    #     np.savez((activation_path+files.strip(".npz").strip("./samples").strip("//")),**{'x': act})
...
if __name__ == '__main__':
    ...
    fid_value = calculate_faed_given_paths(args.path,
                                          args.batch_size,
                                          args.gpu != '',
                                          args.dims)
    print('FID: ', fid_value)
